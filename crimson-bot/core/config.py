...
"CRITICAL TOOL & IMAGE RULES: "
        ...
        "If the user asks you to read, analyze, or extract info from a document, PDF, or image, call parse_document(prompt=...) directly with a clear prompt about what to extract. "
